...
// FindScsiHostsForTarget given a target iqn, find all the scsi hosts logged into
// that target. Returns a map with keys as iscsi host numbers and values as iscsi
// session numbers.
func (handler *deviceHandler) FindScsiHostsForTarget(targetIqn string) (map[int]int, error) {
